...
export const demoBadges: BadgeSummary[] = [
  { id: 'b1', code: 'FIRST_STEP', title: 'Первые шаги', description: 'Получить 50 Биоников.', kind: 'first-step', reward: 100, earnedAt: '2026-06-18T10:00:00Z', progressPercent: 100, locked: false },
  { id: 'b2', code: 'ACTIVIST', title: 'Активист', description: 'Получить 5 достижений.', kind: 'team', reward: 120, earnedAt: null, progressPercent: 60, locked: true },
  { id: 'b3', code: 'MENTOR', title: 'Наставник', description: 'Участие в обучении студентов.', kind: 'mentor', reward: 250, earnedAt: null, progressPercent: 0, locked: true },
  { id: 'b4', code: 'VOLUNTEER', title: 'Волонтёр', description: 'Помощь приюту для животных.', kind: 'team', reward: 150, earnedAt: null, progressPercent: 0, locked: true },
  { id: 'b5', code: 'SPORTSMAN', title: 'Спортсмен', description: 'Участие в спортивных мероприятиях.', kind: 'team', reward: 150, earnedAt: '2026-07-01T10:00:00Z', progressPercent: 100, locked: false },
  { id: 'b6', code: 'MASTER', title: 'Мастер своего дела', description: 'Получить 500 Биоников.', kind: 'leader', reward: 500, earnedAt: null, progressPercent: 37, locked: true },
  { id: 'b7', code: 'LEGEND', title: 'Легенда Бионит', description: 'Получить 2000 Биоников.', kind: 'leader', reward: 1000, earnedAt: null, progressPercent: 9, locked: true },
  { id: 'b8', code: 'PROBATION', title: 'Испытание пройдено', description: 'Окончание испытательного срока.', kind: 'first-step', reward: 200, earnedAt: null, progressPercent: 0, locked: true },
  { id: 'b9', code: 'BIRTHDAY', title: 'Именинник', description: 'День рождения.', kind: 'anniversary', reward: 150, earnedAt: '2026-07-12T09:00:00Z', progressPercent: 100, locked: false },
  { id: 'b10', code: 'NEWBIE', title: 'Новичок', description: 'Завершение онбординга.', kind: 'first-step', reward: 300, earnedAt: null, progressPercent: 30, locked: true }
];
...
export function getDemoOnboarding(): OnboardingData {
  return {
    ...
    knowledge: [
      { id: '54000000-0000-4000-8000-000000000101', title: 'Бионит: компания, продукт и клиенты', summary: 'История ГК «Бионит», масштабы производства, ассортимент и факты для переговоров.', category: 'Продажи · Компания', readMinutes: 9, body: `1. О Группе компаний «Бионит»\n\nГруппа компаний «Бионит» основана в 1991 году владимирскими учёными-биологами и фармацевтами. За 35 лет прошла путь от лаборатории до современного завода площадью 3 000 м².\n\n• Более 130 сотрудников\n• Производство по стандартам GMP\n• 85 регионов РФ + экспорт\n• 52 продукта в портфеле\n• 2,4 млн литров инфузионных растворов в год\n• 360 млн доз вакцин в год` },
      { id: '54000000-0000-4000-8000-000000000102', title: 'Правила игры: задачи, сроки и риски', summary: 'Подготовка к продаже, СПИН-вопросы, презентация и ответы на возражения.', category: 'Продажи · Переговоры', readMinutes: 12, body: `6.1. СБОР ИНФОРМАЦИИ\n\nЧто узнать: период работы, выручка, поголовье, ЛПР, текущие поставщики.\n\n6.2. УСТАНОВЛЕНИЕ КОНТАКТА\nЦель: договориться о встрече.\n\n6.3. ПРЕЗЕНТАЦИЯ\nТехника СПИН: ситуационные, проблемные, извлекающие, направляющие вопросы.\n\n6.4. РАБОТА С ВОЗРАЖЕНИЯМИ\n\n| Возражение | Ответ |\n| --- | --- |\n| «Дорого» | «Давайте посчитаем потери. Курс Миомага — 63 руб., а потери — более 500 тыс. руб.» |\n| «Работаем с другим» | «Предлагаю пробу на 10 головах через месяц оценить результаты.» |\n| «Нет денег» | «Обсудим отсрочку или тестовую партию.» |\n| «Окситоцин дешевле» | «В пересчёте на курс Миомаг дешевле и эффективнее — 0% эндометритов против 28%.» |` },
      { id: '54000000-0000-4000-8000-000000000103', title: 'Карта поддержки и рабочие системы', summary: 'Корпоративные каналы, операции в 1С и контакты подразделений.', category: 'Продажи · Процессы', readMinutes: 11, body: `ОСНОВНЫЕ СИСТЕМЫ:\n• Почта: sale@bionit.ru\n• 1С ERP: заказы, оплаты, отгрузки\n• CRM: клиенты, сделки\n\nКЛЮЧЕВЫЕ ОПЕРАЦИИ В 1С:\n\n| Задача | Путь |\n| --- | --- |\n| Создать заказ | «Продажи» → «Заказы клиентов» → «Создать» |\n| Проверить оплату | «Продажи» → «Расчёты с клиентами» |\n| Оформить реализацию | «Продажи» → «Накладные к оформлению» |\n\nКОНТАКТЫ:\n\n| Роль | Контакт |\n| --- | --- |\n| Офис | +7 (4922) 34-16-21 |\n| Бухгалтерия | Елена Хуртова, +7 960 719-70-70 |\n| Логист | Татьяна Кравчук, +7 903 833-58-33 |\n| Программист 1С | Владимир Катков, +7 903 647-01-95 |\n| Руководитель | Валерий Распопов, +7 (926) 215-08-83 |` },
      { id: '54000000-0000-4000-8000-000000000104', title: 'Первые 14 дней: контрольные точки', summary: 'Маршрут по воронке продаж: от заказа до отгрузки и оплаты.', category: 'Продажи · Воронка', readMinutes: 15, body: `ДЕНЬ 1 — ПРИНЯТЬ ЗАКАЗ\n• Приём на sale@bionit.ru\n• Ввод в 1С: «Продажи» → «Заказы клиентов» → «Создать»\n\nДЕНЬ 3 — СОГЛАСОВАТЬ ЦЕНУ И ОПЛАТУ\n• Торги: снижать поэтапно\n• Подтверждение: письменное по email или предоплата\n\nДЕНЬ 7 — ПРОВЕРИТЬ ГОТОВНОСТЬ\n• Отчёт: «Приоритеты отгрузок»\n• Способы доставки:\n\n| Способ | Мин. сумма без НДС |\n| --- | --- |\n| Доставка за счёт компании | От 150 000 руб. |\n| Самовывоз | От 100 000 руб. |\n\n• Контроль сроков годности: ОСГ не менее 70%\n\nДЕНЬ 14 — ОФОРМИТЬ ОТГРУЗКУ\n• Реализация: «Накладные к оформлению» → «Оформить по заказам»\n• Постотгрузка: подтверждение получения, контроль оплаты\n• Оригиналы документов: контроль возврата` }
    ],
    questions: [
      { id: 'q1', question: 'Где смотреть задачи и историю по клиенту?', answer: 'В CRM и Битрикс24.', status: 'answered', createdAt: '2026-07-20T15:00:00Z', answeredAt: '2026-07-20T16:00:00Z' }
    ]
  };
}
