    ...
    stages: [
      ...
      },
      {
        ...
        tasks: [
          ...
          {
        id: "54000000-0000-4000-8000-000000000106",
        title: "Работа с претензиями и рекламациями: общий порядок",
        summary: "Виды претензий, порядок приёма и регистрации, роль менеджера по документации и классификация по серьёзности.",
        category: "Документооборот · Претензии и рекламации",
        readMinutes: 4,
        body: `ЧТО ТАКОЕ ПРЕТЕНЗИЯ И РЕКЛАМАЦИЯ?\n\nПретензия — это выражение неудовлетворённости продукцией и/или работой организации. Она может поступить от покупателя, потребителя или государственного органа контроля качества.\n\nВИДЫ ПРЕТЕНЗИЙ\n\n| Тип | Примеры |\n| --- | --- |\n| Критическая | Риск для здоровья, отсутствие терапевтического эффекта, побочные действия |\n| Серьёзная | Ошибки в инструкции, дефекты качества, подозрение на фальсификацию |\n| Незначительная | Ошибки в документах, некачественная маркировка, нарушение упаковки |\n\nКАК ПОСТУПАЕТ ПРЕТЕНЗИЯ?\n\n• по почте (письмом);\n• по телефону (устно);\n• по электронной почте;\n• лично в организации.\n\nВажно: все претензии должны быть зарегистрированы в Журнале регистрации претензий в день поступления.\n\nЧТО ДЕЛАТЬ ПРИ ПОЛУЧЕНИИ ПРЕТЕНЗИИ?\n\n1. Принять и зарегистрировать претензию в Журнале регистрации претензий.\n2. Собрать все документы от клиента (письма, акты, фото, протоколы).\n3. Передать информацию Уполномоченному лицу по качеству.\n4. Участвовать в расследовании — собирать документы по серии, проверять отгрузочные документы.\n5. Подготовить служебную записку или отчёт по результатам расследования.\n6. Отследить выполнение корректирующих действий.\n\nКЛАССИФИКАЦИЯ ПО СЕРЬЁЗНОСТИ\n\n| Категория | Описание | Примеры |\n| --- | --- | --- |\n| Критическая | Риск для здоровья, отсутствие эффекта | Подозрение на фальсификацию, нежелательные реакции |\n| Серьёзная | Нет риска для здоровья, но есть нарушения качества | Ошибки в инструкции, несоответствие по спецификации |\n| Незначительная | Протокольные ошибки, нет негативных последствий | Ошибки в маркировке, отсутствие компонентов упаковки |\n\nЧТО ДЕЛАТЬ С ПРЕТЕНЗИЕЙ ДАЛЬШЕ?\n\n1. Зарегистрировать в Журнале.\n2. Передать Уполномоченному лицу.\n3. Создать комиссию по расследованию (ОКК, ОМСС, производство).\n4. Провести расследование: проверить досье на серию, контрольные тесты архивных образцов, документацию.\n5. Оформить Отчёт о расследовании претензии.\n6. Информировать заявителя о результатах.`
      },
      {
        id: "54000000-0000-4000-8000-000000000107",
        title: "Отзыв несоответствующей продукции",
        summary: "Процедура изъятия продукции, не соответствующей качеству: причины, этапы, документы и решения.",
        category: "Документооборот · Претензии и рекламации",
        readMinutes: 5,
        body: `ЧТО ТАКОЕ ОТЗЫВ ПРОДУКЦИИ?\n\nОтзыв продукции — это процедура изъятия из обращения продукции, которая не соответствует установленным требованиям качества или имеет предполагаемое нарушение качества.\n\nПРИЧИНЫ ДЛЯ ОТЗЫВА:\n\n• Отклонения в производстве, упаковке, маркировке, хранении, транспортировке.\n• Несоответствующие результаты контроля качества.\n• Подозрение или выявление фальсификации.\n• Претензии и рекламации потребителей.\n\nКТО ПРИНИМАЕТ РЕШЕНИЕ?\n\nРешение об отзыве принимает Уполномоченное лицо (директор по качеству) на заседании Совета по качеству.\n\nТВОЯ РОЛЬ КАК МЕНЕДЖЕРА:\n\n1. Получить распоряжение на проведение контрольных тестов.\n2. Подготовить Извещение об отзыве и разослать его покупателям.\n3. Собрать информацию о наличии отзываемой серии у покупателей.\n4. Зафиксировать все действия в Отчёте о рассылке извещений.\n5. Передать данные о возврате продукции на склад.\n6. Оформить Протокол возврата несоответствующей продукции.\n\nКАК ПРОХОДИТ ОТЗЫВ?\n\nШаг 1. Принятие решения\nУполномоченное лицо принимает решение. Документы: Протокол Совета по качеству, Распоряжение на контрольные тесты.\n\nШаг 2. Уведомление покупателей\nФормируется Извещение об отзыве. В нём указывается: наименование, серия, срок годности, причина отзыва.\n\nОбразец: «Просим Вас вернуть продукцию для проведения проверки по качеству в связи с выявленным несоответствием. Возврат осуществить по адресу: г. Владимир, ул. Лакина, 4-Б».\n\nШаг 3. Блокировка на складе\nЗаведующий складом блокирует остатки. Статусная этикетка меняется на «в карантине».\n\nШаг 4. Приём и учёт возврата\nПродукция принимается, проверяется и размещается в карантинной зоне. Данные фиксируются в Журнале и Протоколе возврата.\n\nШаг 5. Решение о судьбе продукции\n\n| Решение | Условие |\n| --- | --- |\n| Уничтожение | Если качество не подтверждено или истёк срок годности |\n| Переработка | Если несоответствие касается маркировки или упаковки |\n| Повторная реализация | Только после дополнительных испытаний ОКК |\n\nДОКУМЕНТЫ ПРИ ОТЗЫВЕ\n\n| Документ | Кто оформляет |\n| --- | --- |\n| Протокол Совета по качеству | Уполномоченное лицо |\n| Распоряжение на контрольные тесты | Уполномоченное лицо |\n| Извещение об отзыве | Специалист по продажам |\n| Отчёт о рассылке извещений | Специалист по продажам |\n| Журнал регистрации возврата | Заведующий складом |\n| Протокол возврата | Уполномоченное лицо |`
      },
      {
        id: "54000000-0000-4000-8000-000000000108",
        title: "Управление претензиями: основные принципы",
        summary: "Процесс приёма, оценки и расследования претензий, роли участников и показатели эффективности.",
        category: "Документооборот · Претензии и рекламации",
        readMinutes: 4,
        body: `ЧТО ТАКОЕ УПРАВЛЕНИЕ ПРЕТЕНЗИЯМИ?\n\nЭто процесс приёма, оценки, расследования и устранения претензий от потребителей. Цель — поддержать лояльность и удовлетворённость клиентов.\n\nОСНОВНЫЕ ПРИНЦИПЫ\n\n• Ориентация на потребителя — компания открыта для обратной связи.\n• Доступность — контакты указаны на упаковке, в инструкции и на сайте.\n• Прослеживаемость — каждая претензия регистрируется.\n• Объективность — расследование проводится честно и всесторонне.\n\nКАК РАБОТАЕТ ПРОЦЕСС\n\n| Этап | Действие |\n| --- | --- |\n| 1. Приём | Клиент подаёт претензию, сотрудник регистрирует её в Журнале |\n| 2. Оценка | Уполномоченное лицо оценивает важность, сложность, последствия |\n| 3. Расследование | Комиссия проверяет документы, образцы, условия хранения |\n| 4. Ответ | Клиенту направляется ответ с решением или мотивированный отказ |\n| 5. Завершение | Проводятся корректирующие действия, претензия закрывается |\n\nКТО ОТВЕЧАЕТ?\n\n| Роль | Ответственность |\n| --- | --- |\n| Генеральный директор | Общее управление процессом |\n| Уполномоченное лицо | Расследование, принятие решений, отчётность |\n| Руководитель ОМСС | Организация работы с клиентами, хранение документов |\n| Менеджер по документации | Регистрация, сбор документов, подготовка отчётов |\n| Начальник ООК | Контроль качества, актуализация нормативных документов |\n\nПОКАЗАТЕЛИ ЭФФЕКТИВНОСТИ\n\n| Показатель | Целевое значение |\n| --- | --- |\n| Удовлетворённость потребителей | 20–25 баллов (из 35) |\n| Решение проблем, вызвавших претензию | Не менее 80% |\n| Выполнение мероприятий в срок | Не менее 95% |\n\nЧТО ДЕЛАТЬ С ПОВТОРНОЙ ПРЕТЕНЗИЕЙ?\n\nЕсли клиент не согласен — претензия остаётся открытой с пометкой «П» (повторное рассмотрение) и проходит полный цикл заново.\n\nХРАНЕНИЕ ДОКУМЕНТОВ\n\nВсе документы хранятся у руководителя ОМСС. Срок хранения — не менее 3 лет.\n\nНЕСТАНДАРТНЫЕ СИТУАЦИИ\n\n• Претензия необоснованна → мотивированный отказ.\n• Клиент не согласен → повторное расследование.\n• Страховой случай → направить клиента в страховую компанию.`
      }
          ],
          {
