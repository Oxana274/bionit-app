...
export function getDemoOnboarding(): OnboardingData {
  ...
  },
  {
    ...
    readMinutes: 15,
    body: `ДЕНЬ 1 — ПРИНЯТЬ И ВВЕСТИ ЗАКАЗ\n\n• Заказы принимаются на sale@bionit.ru\n• Ввести заказ в 1С: «Продажи» → «Заказы клиентов» → «Создать»\n• Статусы: «На согласовании» (по умолчанию), «К выполнению» (после подтверждения)\n\nДЕНЬ 3 — СОГЛАСОВАТЬ ЦЕНУ И ОПЛАТУ\n\n• Торги: не предлагать минимальную цену сразу\n• Подтверждение: письменное по email или предоплата\n• Проверить оплату: «Продажи» → «Расчёты с клиентами»\n\nДЕНЬ 7 — ПРОВЕРИТЬ ГОТОВНОСТЬ И ЛОГИСТИКУ\n\n• Отчёт: «Приоритеты отгрузок»\n• Способы доставки: самовывоз, доставка за счёт компании\n• Мин. сумма: доставка от 150 000 руб., самовывоз от 100 000 руб.\n• Контроль сроков годности (ОСГ не менее 70%)\n\nДЕНЬ 14 — ОФОРМИТЬ ОТГРУЗКУ\n\n• Оформить реализацию: «Накладные к оформлению» → «Оформить по заказам»\n• Оформить счёт-фактуру\n• Постотгрузка: подтверждение получения, контроль оплаты\n• Оригиналы документов: проконтролировать возврат`
  }
],
questions: [
