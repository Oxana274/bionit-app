  ...
  return {
    ...
    knowledge: [
      ...
      },
      {
        ...
        readMinutes: 6,
        body: `В Бионит ценятся прозрачность, аккуратность и ответственность за результат.\n\nДо начала задачи уточните\n1. Какой результат нужен?\n2. К какому сроку?\n3. По какому критерию результат будет принят?\n4. Какие ресурсы доступны?\n\nЕсли срок или результат под угрозой\nПредупредите заранее: риск, причину, нужную помощь и новый срок.`
      },
      {
        ...
        readMinutes: 6,
        body: `Карта поддержки\n• руководитель — приоритеты и решения\n• наставник — первые действия\n• HR — адаптация\n• IT — доступы\n\nРабочие системы\n• Битрикс24 — задачи\n• CRM — клиенты\n• 1С — учёт`
      },
      {
        ...
        readMinutes: 5,
        body: `День 1\nОформление, Welcome-тренинг, доступы.\n\nДень 3\nПонятна роль, правила, клиентские процессы.\n\nДень 7\nВыполнены первые действия, доступны CRM и шаблоны.\n\nДень 14\nСогласованный план, первые результаты, обратная связь.`
      }
    ],
    questions: [
