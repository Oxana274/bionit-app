    ...
    knowledge: [
      {
        ...
        readMinutes: 7,
        body: `Группа компаний «Бионит» основана в 1991 году владимирскими учеными-биологами и фармацевтами. За 35 лет предприятие прошло путь от небольшой лаборатории до современного завода площадью 3000 м².\n\nВ компании работает более 130 человек. Производство — по стандартам GMP, строгий контроль качества.\n\nПоставки: 85 регионов России + экспорт в 10 стран.\n\nНаграды: «Экспортёр года» в АПК, финал премии «Молодой промышленник года».\n\nАссортимент: 52 продукта — вакцины, антибиотики, гинекологические, гормональные, противопаразитарные препараты.\n\nПроизводство: 2,4 млн литров инфузионных растворов в год, 360 млн доз вакцин.\n\nСоциальная ответственность: мини-футбольная команда, помощь приютам, обучение студентов.\n\nКлючевые факты для клиента: 35 лет на рынке, GMP-сертификация, 85 регионов РФ, 11 стран экспорта, консультации и обучение.`
      },
      {
        ...
        readMinutes: 6,
        body: `До начала задачи уточните четыре пункта:\n1. Какой результат нужен?\n2. К какому сроку?\n3. По какому критерию результат будет принят?\n4. Какие ресурсы, данные и согласования доступны?\n\nЕсли срок или результат под угрозой — предупредите заранее и назовите: риск, причину, нужную помощь и новый реалистичный срок.\n\nНе скрывайте риски, связанные с качеством, безопасностью, конфиденциальностью или обязательствами перед клиентом.\n\nДля менеджера по продажам CRM — рабочая память. Фиксируйте: клиента, статус, договорённость, следующий шаг, ответственного и срок сразу после контакта.\n\nПравила работы:\n• Все задачи фиксируем письменно\n• О сроках предупреждаем заранее\n• Если что-то непонятно — спрашиваем сразу`
      },
            {
        ...
        readMinutes: 6,
        body: `Карта поддержки:\n• Руководитель — приоритеты, задачи и решения\n• Наставник — первые действия и рабочие нюансы\n• HR — адаптация и вопросы по процессу\n• IT — техника, учётные записи и доступы\n• Продуктовый эксперт — вопросы по препаратам\n\nРабочие системы:\n• Битрикс24 — задачи, коммуникация, файлы\n• Корпоративная почта — внешняя коммуникация\n• CRM — клиенты, контакты, сделки, история\n• 1С — учёт, склад, документооборот\n• Корпоративная папка — шаблоны КП, договоров, презентаций\n\nПравило эскалации: если ответ блокирует работу и его нет в срок — повторите вопрос и обратитесь к следующему ответственному.\n\nКлючевые контакты:\n• Офис: +7 (4922) 34-16-21\n• Почта: sale@bionit.ru\n• Сайт: bionit.ru\n• Бухгалтерия: Елена Хуртова, +7 960 719 70 70\n• Логист: Татьяна Кравчук, +7 903 833-58-33\n• Программист 1С: Катков Владимир, +7 903 647 01 95\n• Руководитель: Распопов Валерий Иванович, +7 (926) 215-08-83`
      },
      {
        ...
        readMinutes: 5,
        body: `День 1: Оформление, Welcome-тренинг, доступы, знакомство с руководителем и наставником.\n\nДень 3: Понятна роль менеджера, основные правила, клиентские процессы, точки контакта и первые задачи.\n\nДень 7: Выполнены первые рабочие действия, доступны CRM и шаблоны, сформулированы вопросы по продукту и клиентам.\n\nДень 14: Согласованный план на испытательный срок, первые зафиксированные результаты и обратная связь от руководителя.\n\nЛичный чек-лист:\n• Получены доступы и контакты поддержки\n• Понятны основные продукты и типы клиентов\n• Известно, где фиксируются задачи, сроки и клиентская история\n• Заполнен план первых 14 дней\n• Назначена встреча обратной связи\n\nВ конце второй недели обсудите с руководителем: что уже получается, где остаются вопросы и какая поддержка нужна дальше.`
      }
    ],
    questions: [
